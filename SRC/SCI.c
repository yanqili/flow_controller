...
// InitPeripherals(); // Not required for this example
   ...
   ConfigCpuTimer(&CpuTimer0, 150, 7500); //AD ，DA用
...
void InitParameter(void)
{
	...
	CMD[1]=0xBB;
	CMD[2]=9;
	pre_cmd_data[0]=0x5A;//发出控制指令
	pre_cmd_data[1]=0xB2;
	pre_cmd_data[2]=0xAA;
	pre_cmd_data[7]=0x23;
	pre_act_data[0]=0x5A; //接收实际数据
	pre_act_data[1]=0xB2;
	pre_act_data[2]=0x55;
	pre_act_data[7]=0x23;
